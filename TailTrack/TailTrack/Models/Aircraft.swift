...
enum AircraftLibrary {
    ...
    static let presets: [Preset] = [
        Preset(typeCode: "C120", name: "Cessna 120", cruiseKt: 89),
        Preset(typeCode: "C140", name: "Cessna 140", cruiseKt: 91),
        Preset(typeCode: "C150", name: "Cessna 150", cruiseKt: 100),
        Preset(typeCode: "C152", name: "Cessna 152", cruiseKt: 107),
        Preset(typeCode: "C170", name: "Cessna 170", cruiseKt: 104),
        Preset(typeCode: "C172", name: "Cessna 172 Skyhawk", cruiseKt: 122),
        Preset(typeCode: "C177", name: "Cessna 177 Cardinal", cruiseKt: 134),
        Preset(typeCode: "C180", name: "Cessna 180 Skywagon", cruiseKt: 141),
        Preset(typeCode: "C185", name: "Cessna 185 Skywagon", cruiseKt: 145),
        ...
        Preset(typeCode: "P28B", name: "Piper Dakota", cruiseKt: 143),
        Preset(typeCode: "P28R", name: "Piper Arrow", cruiseKt: 137),
        Preset(typeCode: "PA18", name: "Piper Super Cub", cruiseKt: 100),
        Preset(typeCode: "PA24", name: "Piper Comanche", cruiseKt: 160),
        ...
        Preset(typeCode: "BE23", name: "Beechcraft Musketeer", cruiseKt: 117),
        Preset(typeCode: "BE33", name: "Beechcraft Debonair", cruiseKt: 165),
        Preset(typeCode: "BE35", name: "Beechcraft Bonanza 35", cruiseKt: 165),
        Preset(typeCode: "AA5", name: "Grumman Traveler / Cheetah", cruiseKt: 127),
        ...
        Preset(typeCode: "DA42", name: "Diamond DA42 Twin Star", cruiseKt: 165),
        Preset(typeCode: "RV6", name: "Van's RV-6", cruiseKt: 158),
        Preset(typeCode: "RV7", name: "Van's RV-7", cruiseKt: 165),
        Preset(typeCode: "RV8", name: "Van's RV-8", cruiseKt: 170),
        Preset(typeCode: "RV10", name: "Van's RV-10", cruiseKt: 175),
        Preset(typeCode: "RV12", name: "Van's RV-12", cruiseKt: 108),
        Preset(typeCode: "J3", name: "Piper J-3 Cub", cruiseKt: 70),
        Preset(typeCode: "CH7A", name: "Citabria", cruiseKt: 105),
        Preset(typeCode: "8KCAB", name: "Decathlon", cruiseKt: 128),
